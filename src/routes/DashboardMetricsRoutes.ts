...
router.get('/rooms/status-by-type', DashboardMetricsController.getRoomStatusByType);
...
router.get('/rooms/occupancy-percentage', DashboardMetricsController.getOccupancyPercentage);
 ...
 *                   type: string
 */
router.get('/rooms/adr', DashboardMetricsController.fetchADR);
...
router.get('/reservations/due-out', DashboardMetricsController.getDueOutReservations);
...
router.get('/reservations/by-status', DashboardMetricsController.getReservationsByStatus);
...
router.get('/reservations/count-by-status', DashboardMetricsController.countReservationsByStatus);
...
router.get('/reservations/total-outstanding-balance', DashboardMetricsController.getTotalOutstandingBalance);
...
router.get('/reservations/yearly-revenue', DashboardMetricsController.getYearlyRevenue);
...
router.get('/reservations/yearly-occupancy-adr', DashboardMetricsController.getYearlyOccupancyAndADR);
