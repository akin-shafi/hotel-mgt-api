...
const UsbController_1 = require("../controllers/UsbController");
 ...
 *                         type: object
 */
router.get("/", UsbController_1.UsbController.listDevices);
/**
 * @swagger
 * /api/printers:
 *   get:
 ...
 *                     type: object
 */
router.get("/printers", UsbController_1.UsbController.listPrinters);
/**
 * @swagger
 * /api/print:
 *   post:
 ...
 */
router.post("/print", UsbController_1.UsbController.printTest);
