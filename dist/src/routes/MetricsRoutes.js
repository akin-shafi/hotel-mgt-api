...
const CombinedController_1 = __importDefault(require("../controllers/CombinedController"));
 ...
 *                   type: string
 */
router.get('/metrics/all', CombinedController_1.default.getAllMetrics);
/**
 * @swagger
 ...
 *                   type: string
 */
router.get('/metrics/room-metrics', MetricsController_1.default.getRoomMetrics);
/**
 * @swagger
 ...
 *                   type: string
 */
router.get('/metrics/date-based-metrics', MetricsController_1.default.getDateBasedMetrics);
/**
 * @swagger
 ...
 *                   type: string
 */
router.get('/metrics/year-based-metrics', MetricsController_1.default.getYearBasedMetrics);
