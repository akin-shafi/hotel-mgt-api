...
class RoomTypeController {
    ...
    static getRoomTypesByHotel(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const roomTypes = yield RoomTypeService_1.RoomTypeService.getRoomTypesByHotel(hotelId);
    ...
    static getRoomTypeById(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
    ...
    static getRoomTypeDataByHotelId(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const { hotelId } = req.params;
                const rooms = yield RoomTypeService_1.RoomTypeService.getAllRoomTypeDataByHotelId(hotelId);
